...
import pers.fl.server.service.TagService;

import javax.annotation.Resource;

import java.util.List;

import static pers.fl.common.constant.OptTypeConst.SAVE_OR_UPDATE;
import static pers.fl.server.search.mq.PostMqIndexMessage.REMOVE;

/**
 * 标签管理模块
 *
 * @author fengliang 2021年01月27日
 */
